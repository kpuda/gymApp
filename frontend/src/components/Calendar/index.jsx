    ...
    return (
        <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={4} lg={3}>
                <Paper className="paper">
                    { editing
                        ?
                            <>
                                <h3>Edytuj aktywność na {selectedDay.day}-{selectedDay.month + 1} </h3>
                                <EditActivity
                                    activity={activity}
                        ...
                        :
                            <>
                                <h3>Dodaj aktywność na {selectedDay.day}-{selectedDay.month + 1} </h3>
                                <AddActivity
                                    selectedDay={selectedDay}
                                    authUser={props.authUser}
                                    setOpenSnackbar={setOpenSnackbar}
            ...
            <Grid item xs={12} md={7}>
                <Paper className="paper">
                <h3>Działania na {selectedDay.day}-{selectedDay.month + 1}</h3>
                <ActivityList
                    loading={loading}
